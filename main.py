...
stopuser = {}
token = '7358975707:AAG_i87C48awWs6jr-hy81DaZhEqwYClKGo'
bot=telebot.TeleBot(token,parse_mode="HTML")
admin=1626254964 #ايدي الادمن بدون علامات تنصيص
command_usage = {}
...
''',reply_markup=keyboard)
		...
		''',reply_markup=keyboard)
			...
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text=f" Braintree Auth 1",callback_data='br')
		sw = types.InlineKeyboardButton(text=f" Braintree Auth 2",callback_data='sq')
		keyboard.add(contact_button)
		keyboard.add(sw)
		...
		try:
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					...
					risk = types.InlineKeyboardButton(f"• Rick 🏴‍☠️ ➜ [ {riskk} ] •", callback_data='x')
